...
<div class="space-y-6">
	<!-- Strategy Selection -->
	<div>
		<h3 class="text-lg font-semibold text-gray-900 mb-4">Choose Payoff Strategy</h3>
		...
		<div class="space-y-3">
			...
			>
				...
				/>
				<div class="ml-3">
					<span class="block text-sm font-medium text-gray-900">Snowball Method</span>
			...
			>
				...
				/>
				<div class="ml-3">
					<span class="block text-sm font-medium text-gray-900">Avalanche Method</span>
					<span class="block text-sm text-gray-600 mt-1">
			...
			>
				...
				/>
				<div class="ml-3">
					<span class="block text-sm font-medium text-gray-900">Custom Priority</span>
					<span class="block text-sm text-gray-600 mt-1">
			...
			<div class="space-y-2">
				{#each orderedDebts() as debt, index}
					<div
						...
						class="flex items-center gap-3 p-3 bg-white border border-gray-300 rounded-md cursor-move hover:border-blue-400 transition-colors {draggedIndex ===
						index
							? 'opacity-50'
							: ''}"
					>
